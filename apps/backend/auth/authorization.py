...
async def has_any_permission(user_id: str, permissions: List[str], db: Session) -> bool:
    """
...
async def has_all_permissions(
    user_id: str, permissions: List[str], db: Session
) -> bool:
    """
...
async def check_resource_permission(
    user_id: str, resource: str, action: str, db: Session
) -> bool:
    """
