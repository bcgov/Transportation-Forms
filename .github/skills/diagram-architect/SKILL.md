...
correct mxGraph XML structure. All generated files open immediately in the Draw.io VS Code extension.
...
|---|---|---|
| Flowchart | `.github/skills/diagram-architect/assets/templates/flowchart.drawio` | Process flows with decisions and branches |
| System Architecture | `.github/skills/diagram-architect/assets/templates/architecture.drawio` | Multi-tier / layered service architecture |
| Sequence Diagram | `.github/skills/diagram-architect/assets/templates/sequence.drawio` | Actor lifelines and timed message flows |
| ER Diagram | `.github/skills/diagram-architect/assets/templates/er-diagram.drawio` | Database tables with relationships |
| UML Class Diagram | `.github/skills/diagram-architect/assets/templates/uml-class.drawio` | Classes, interfaces, enums, relationships |
...
- **Python 3.8+** (optional) — for the validation and shape-insertion scripts in `.github/skills/diagram-architect/scripts/`
...
4. **Output path** Must ask — Where should the `.drawio` file be saved?
...
- **Use a template** when the diagram type matches one in `.github/skills/diagram-architect/assets/templates/`. Copy the template structure and replace placeholder values.
...
> See `.github/skills/diagram-architect/references/style-reference.md` for the complete style key catalog and `.github/skills/diagram-architect/references/shape-libraries.md` for all shape library names.
...
Use `.github/skills/diagram-architect/scripts/add-shape.py` to safely add a single shape without editing raw XML:
```bash
python .github/skills/diagram-architect/scripts/add-shape.py docs/arch.drawio "New Service" 700 380
```
...
- Place diagrams alongside the code they document: `/docs/diagrams/`
...
| Shape style not rendering | Typo in shape= name | Check `.github/skills/diagram-architect/references/shape-libraries.md` for exact style string |
...
```bash
python .github/skills/diagram-architect/scripts/validate-drawio.py <file.drawio>
```
...
All companion files are in `.github/skills/diagram-architect/`:

| File | Contents |
|---|---|
| `.github/skills/diagram-architect/references/drawio-xml-schema.md` | Complete mxfile / mxGraphModel / mxCell attribute reference, coordinate system, reserved cells, validation rules |
| `.github/skills/diagram-architect/references/style-reference.md` | All style keys with allowed values, vertex and edge style keys, shape catalog, semantic color palette |
| `.github/skills/diagram-architect/references/shape-libraries.md` | All shape library categories (General, Flowchart, UML, ER, Network, BPMN, Mockup, K8s) with style strings |
| `.github/skills/diagram-architect/assets/templates/flowchart.drawio` | Ready-to-use flowchart template |
| `.github/skills/diagram-architect/assets/templates/architecture.drawio` | 4-tier system architecture template |
| `.github/skills/diagram-architect/assets/templates/sequence.drawio` | 3-actor sequence diagram template |
| `.github/skills/diagram-architect/assets/templates/er-diagram.drawio` | 3-table ER diagram with crow's foot relationships |
| `.github/skills/diagram-architect/assets/templates/uml-class.drawio` | Interface + 2 classes + enum with relationship arrows |
| `.github/skills/diagram-architect/scripts/validate-drawio.py` | Python script to validate XML structure of any .drawio file |
| `.github/skills/diagram-architect/scripts/add-shape.py` | Python CLI to add a new shape to an existing diagram |
| `.github/skills/diagram-architect/scripts/README.md` | How to use the scripts with examples |
